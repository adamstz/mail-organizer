                ...
                if is_external_image(img):
                    ...
                    if block_images:
                        ...
                        placeholder = (
                            ...
                            'height="100"%3E%3Crect fill="%23ddd" width="100" height="100"/%3E%3Ctext '
                            'x="50" y="50" text-anchor="middle" fill="%23999" font-size="12"%3E'
                            'Image Blocked%3C/text%3E%3C/svg%3E'
                        )
                        img['src'] = placeholder
